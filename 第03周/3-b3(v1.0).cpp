...
int main()
{
	...
	double decimal_changed_1;
	double decimal_changed_2;
	double decimal_changed_3;
	...
	//数字处理
	decimal_changed_1=(pow(10,15)+x_decimal_int__stored_double)/pow(10,15);
	decimal_changed_2=decimal_changed_1+5*pow(10,-16);
	decimal_changed_3=(decimal_changed_2-1)*pow(10,15);

	//处理完的数字存在long int型变量中
	x_decimal_int__stored_int=long int(decimal_changed_3);
