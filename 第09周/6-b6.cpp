...
char *tj_strcat(char *s1, const char *s2) //finish
{
	char *read=(char *)s2;
	char *write=s1;
...
char *tj_strcpy(char *s1, const char *s2) //finish
{
	char *read=(char *)s2;
	char *write=s1;
...
char *tj_strncpy(char *s1, const char *s2, const int len) //finish
{
	char *read=(char *)s2;
	char *write=s1;
	int counter=0;
...
int tj_strcmp(const char *s1, const char *s2) //finish
{
	char *read1;
	char *read2;
	read1=(char *)s1;
...
int tj_strcasecmp(const char *s1, const char *s2) //finish
{
	char *read1;
	char *read2;
	read1=(char *)s1;
	...
	if		(*read1<=64)				 letter1=false;
	else if ((*read1>=91)&&(*read1<=96)) letter1=false;
	else if (*read1>=123)				 letter1=false;
	else								 letter1=true;

	if		(*read2<=64)				 letter2=false;
	else if ((*read2>=91)&&(*read2<=96)) letter2=false;
	else if (*read2>=123)				 letter2=false;
	else								 letter2=true;

	if (abs(*read1-*read2)==32)          flag=true;
	else                                 flag=false;

	for (;(*read1==*read2)||(letter1&&letter2&&flag);)
	{
		if (*read1=='\0')
		{
			break;
...
int tj_strcasencmp(const char *s1, const char *s2, const int len) //finish
{
	char *read1;
	char *read2;
	read1=(char *)s1;
    ...
    return ((letter1&&letter2&&flag)?(0):(*read1-*read2));
}

char *tj_strupr(char *str) //finish
{
	char *s;
	s=str;
	for (;*s!='\0';s++)
...
char *tj_strlwr(char *str) //finish
{
	char *s;
	s=str;
	for (;*s!='\0';s++)
...
int tj_strchr(const char *str, const char ch) //finish
{
	char *s;
	s=(char *)str;
	int counter=1;
...
int tj_strstr(const char *str, const char *substr) //finish
{
	char *s;
	s=(char *)str;
	int counter=1;
...
int tj_strrchr(const char *str, const char ch) //finish
{
	char *s;
	s=(char *)str+tj_strlen(str)-1;
	int counter=tj_strlen(str);
...
int tj_strrstr(const char *str, const char *substr) //finish
{
	char *s;
	s=(char *)str+tj_strlen(str)-tj_strlen(substr);
	int counter=tj_strlen(str)-tj_strlen(substr)+1;
...
char *tj_strrev(char *str) //finish
{
	char *exchange1;
	exchange1=str;
	char *exchange2;
	exchange2=str+tj_strlen(str)-1;
	char *temp;
	char t;
	temp=&t;

	for (;exchange1<exchange2;)
	{
		*temp=*exchange1;
		*exchange1=*exchange2;
		*exchange2=*temp;
